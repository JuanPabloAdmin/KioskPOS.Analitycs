...
public class MongoDbAnalyticsDbSchemaMigrator : IAnalyticsDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAnalyticsDbSchemaMigrator(IServiceProvider serviceProvider)
    {
